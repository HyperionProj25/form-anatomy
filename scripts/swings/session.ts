...
/**
 * Session-level helpers for the TrackMan exports (spec section 18): reading one play by byte
 * range, bat speed from the tip track, TrackMan's own segment angles for agreement checks,
